...
public class MessageController {
    ...
    @PostMapping
    @Operation(summary = "Creates a new message", description = "Creates a new message with the provided inputs", responses = {
            @ApiResponse(responseCode = "200", description = "Message created", content = @Content(schema = @Schema(implementation = MessageResponseDTO.class))),
